...
var HttpConnection = /** @class */ (function () {
    ...
    HttpConnection.prototype.resolveUrl = function (url) {
        ...
        var resultUrl = (aTag.baseURI + "/" + url).replace(new RegExp("([^:])(/){2,150}"), "$1/");
        this.logger.log(_ILogger__WEBPACK_IMPORTED_MODULE_1__["LogLevel"].Information, "Normalizing '" + url + "' to '" + resultUrl + "'.");
        return resultUrl;
    };
